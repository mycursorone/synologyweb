          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                &ldquo;美步的 NAS 设备为我们公司提供了可靠的数据存储和备份解决方案。系统稳定，管理界面直观易用，大大提高了我们的工作效率。&rdquo;
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                &ldquo;作为一名专业摄影师，我需要大容量、高速度的存储设备。美步的 DS1621+ 完美满足了我的需求，照片管理功能非常强大，我非常满意！&rdquo;
              </p>
              <div className="flex text-yellow-400 mt-4">
                <span>★</span>
                <span>★</span>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                &ldquo;美步的 DS220+ 是我家庭媒体中心的核心。它不仅存储了我们所有的照片和视频，还能作为媒体服务器，让我们在任何设备上观看电影和电视剧。&rdquo;
              </p>
              <div className="flex text-yellow-400 mt-4">
                <span>★</span>
                <span>★</span>
